...
public class InputReaderTests
{
    ...
    [Fact]
    public void MapKey_P_ReturnsShowPreviewMenu()
    {
        var evt = new KeyEvent(ConsoleKey.P, 'p', false, false, false);
        Assert.Equal(AppAction.ShowPreviewMenu, InputReader.MapKey(evt));
    }
    ...
    [Fact]
    public void MapKey_CtrlF_ReturnsShowFileFinder()
    {
        var evt = new KeyEvent(ConsoleKey.F, '\u0006', false, false, true);
        Assert.Equal(AppAction.ShowFileFinder, InputReader.MapKey(evt));
    }
