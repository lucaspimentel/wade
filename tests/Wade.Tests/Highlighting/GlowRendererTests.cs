...
public class GlowRendererTests
{
    ...
    {
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput("hello world");
        Assert.Single(lines);
    ...
    {
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput("\x1b[1mhello\x1b[0m");
        Assert.Single(lines);
    ...
    {
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput($"\x1b[{sgrCode}mX\x1b[0m");
        Assert.Single(lines);
        Assert.NotNull(lines[0].CharStyles);
    ...
    public void ParseAnsiOutput_BrightFgColor_MapsToCorrectPalette()
    {
        ...
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput("\x1b[91mX\x1b[0m");
        Assert.Single(lines);
        Assert.NotNull(lines[0].CharStyles);
    ...
    {
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput("\x1b[4mAB\x1b[24mCD");
        Assert.Single(lines);
        Assert.Equal("ABCD", lines[0].Text);
        Assert.NotNull(lines[0].CharStyles);
        CellStyle[] styles = lines[0].CharStyles!;
    ...
    public void ParseAnsiOutput_256Color_6x6x6Cube()
    {
        ...
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput("\x1b[38;5;196mX\x1b[0m");
        Assert.Single(lines);
        Assert.NotNull(lines[0].CharStyles);
    ...
    {
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput("\x1b[38;2;100;200;50mX\x1b[0m");
        Assert.Single(lines);
        Assert.NotNull(lines[0].CharStyles);
    ...
    {
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput("hello   ");
        Assert.Single(lines);
        Assert.Equal("hello", lines[0].Text);
    }
    ...
    {
        StyledLine[] lines = GlowRenderer.ParseAnsiOutput("line1\nline2\nline3");
