...
- **Cloud file handling** — OneDrive, Dropbox, and other cloud-synced placeholder files are detected automatically (Windows only); shown with a cloud icon and dim styling; preview is skipped to avoid triggering downloads; properties overlay shows "Cloud placeholder" type
